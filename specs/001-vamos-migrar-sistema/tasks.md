...
- [ ] T001 Create .NET solution structure at `backend/CaixaSeguradora.sln` with three projects (Api, Core, Infrastructure)
- [ ] T002 [P] Initialize CaixaSeguradora.Api project with ASP.NET Core Web API 9.0 in `backend/src/CaixaSeguradora.Api/`
- [ ] T003 [P] Initialize CaixaSeguradora.Core project (class library) in `backend/src/CaixaSeguradora.Core/`
- [ ] T004 [P] Initialize CaixaSeguradora.Infrastructure project (class library) in `backend/src/CaixaSeguradora.Infrastructure/`
- [ ] T005 [P] Initialize test project CaixaSeguradora.UnitTests in `backend/tests/CaixaSeguradora.UnitTests/`
- [ ] T006 [P] Initialize test project CaixaSeguradora.IntegrationTests in `backend/tests/CaixaSeguradora.IntegrationTests/`
- [ ] T007 [P] Initialize test project CaixaSeguradora.ComparisonTests in `backend/tests/CaixaSeguradora.ComparisonTests/`
- [ ] T008 Add NuGet packages to Api project (Swashbuckle, Serilog, AutoMapper)
