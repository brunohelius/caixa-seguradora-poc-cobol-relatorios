...
namespace CaixaSeguradora.Infrastructure.Migrations
{
    ...
    [Migration("20251027225829_InitialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.FileOutput", b =>
                {
                    ...
                    b.HasIndex("ExecutionId", "FileType")
                        .HasDatabaseName("IX_FileOutput_Execution_FileType");

                    b.ToTable("FILE_OUTPUTS", (string)null);
                });
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.Policy", b =>
                {
                    ...
                    b.Property<int>("ProposerClientCode")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RamoSusep")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.ProcessingLog", b =>
                {
                    b.Property<long>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("CobolSection")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ExecutionId", "Severity")
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.ReinsuranceData", b =>
                {
                    ...
                    b.Property<short>("ProductCode")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RamoSusep")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("ReinsurancePercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("DECIMAL(5,2)");

                    b.Property<decimal>("ReinsuredAmount")
                        .HasPrecision(15, 2)
                        .HasColumnType("DECIMAL(15,2)");
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.ReportExecution", b =>
                {
                    b.Property<Guid>("ExecutionId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("PremcedRecordsGenerated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);

                    b.Property<int>("PremitRecordsGenerated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);
                    ...
                    b.Property<string>("TriggeringUser")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ReferenceMonth", "Status")
            ...
            modelBuilder.Entity("CaixaSeguradora.Core.Entities.FileOutput", b =>
                {
                    b.HasOne("CaixaSeguradora.Core.Entities.ReportExecution", "Execution")
                        .WithMany("FileOutputs")
